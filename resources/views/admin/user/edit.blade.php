        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header white">
                    <strong> Edit Master User "{{ $user->name }}" </strong>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" autocomplete="off" value="{{ $user->name }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" autocomplete="off" value="{{ $user->email }}">
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" autocomplete="off" value="{{ $user->phone }}">
                                @if ($errors->has('phone'))
                                    <span class="invalid-feedback" role="alert">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.user.index') }}" class="btn btn-outline-danger btn-sm">Cancel</a>
